 ...
 */
public class Maven33ServerEmbedderImpl extends Maven3ServerEmbedder {
  ...
  public Maven33ServerEmbedderImpl(MavenServerSettings settings) throws RemoteException {
    super(settings);
  ...
  public void customize(@Nullable MavenWorkspaceMap workspaceMap,
    ...
    try {
      ...
      ((CustomMaven33ArtifactResolver)getComponent(ArtifactResolver.class)).customize(workspaceMap, failOnUnresolvedDependency);
        ...
        try {
          ...
          if (repositorySession instanceof DefaultRepositorySystemSession) {
            ...
            if (myWorkspaceMap != null) {
              ((DefaultRepositorySystemSession)repositorySession).setWorkspaceReader(new Maven33WorkspaceReader(myWorkspaceMap));
            }
          }
  ...
  private MavenServerExecutionResult createExecutionResult(File file, MavenExecutionResult result, DependencyNode rootNode)
    ...
    try {
      if (USE_MVN2_COMPATIBLE_DEPENDENCY_RESOLVING) {
        ...
        model = Maven33AetherModelConverter
          .convertModelWithAetherDependencyTree(mavenProject.getModel(), mavenProject.getCompileSourceRoots(),
                                                mavenProject.getTestCompileSourceRoots(), mavenProject.getArtifacts(), dependencyNodes,
  ...
  public void reset() throws RemoteException {
    try {
      ...
      ((CustomMaven33ArtifactResolver)getComponent(ArtifactResolver.class)).reset();
